...
group_device.add_argument('--seed', type=int, default=123, help='random seed')
...
group_data.add_argument('--data_train', type=str, default='DSEC', help='training dataset name')
group_data.add_argument('--data_val', type=str, default='DSEC', help='validation dataset name')
group_data.add_argument('--data_test', type=str, default='DSEC', help='test dataset name')
...
group_data.add_argument('--split', type=int, default=1, help='RGB pixel value ranging from 0')
...
group_model.add_argument('--disp_model', type=str, default='GWCNet', help='model architecture')
...
group_test.add_argument('--validate_every', type=int, default=1, help='do validation at every N epochs')
...
group_optim.add_argument('--lr', type=float, default=1e-3, help='learning rate')
group_optim.add_argument('--milestones', type=int, nargs='+', default=[20, 40, 60, 80, 100, 120], help='learning rate decay per N epochs')
...
group_optim.add_argument('--weight_decay', type=float, default=0.0001, help='weight decay')
...
group_log.add_argument('--load_dir', type=str, default=None, help='subdirectory to load experiment logs')
...
if args.dataset is not None:
    ...
    args.data_val = args.dataset if args.dataset not in ['GOPRO_Large', 'synthetic', 'synthetic_event', 'indoor_flying_1', 'indoor_flying_2', 'indoor_flying_3'] else None
